...
let mainQuestions = [
    {
        ...
        type: 3,
        points: 100,
        answers: ['профессиональная деятельность по управлению организацией, обеспечивающий высокую результативность, эффективность работы и целенаправленное устойчивое развитие', 'умение точно в  срок составлять документы и отправлять по электронной почте по указанию руководителя', 'наука об  управлении финансовыми потоками  предприятия', 'умение добиваться поставленных целей, направляя труд, интеллект и мотивы поведения людей','понятие, являющееся синонимом термина «бизнес»','совокупность методов, принципов и средств управления организациями с целью обеспечения высокой эффективности работы',],
    },
];
